...
#include "SMCharacterActionComponent.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class STEREOMIXPROTOTYPE_API USMCharacterActionComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	void ServerBeginAction(const double Timestamp);
...
protected:
	...
	UFUNCTION()
	virtual void OnBeginAction(const double ClientDelay);
	...
	virtual void ClientPlayVisualEffectsOnBegin();
	 ...
	 */
	UFUNCTION(Client, Unreliable)
	virtual void ClientPlayVisualEffectsOnPerform();
